...
func WalkingSpentCalories(action int, duration, weight, height float64) float64 {
	// ваш код здесь
	return ((walkingCaloriesWeightMultiplier*weight + (math.Pow(meanSpeed(action, duration)/kmhInMsec, 2)/height/100)*walkingSpeedHeightMultiplier*weight) * duration * float64(minInH))
}
